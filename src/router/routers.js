...
export default [{
	...
	},
	{
		...
		children: [{
			...
			},
			{
				...
				component: resolve => require(['@/view/vending-machine/v-rtu-management/copy-rtu/copy-rtu.vue'], resolve)
			...
			},
			{
				...
				component: resolve => require(['@/view/vending-machine/v-rtu-management/replenishment/replenishment.vue'], resolve)
				//component: () => import('@/view/vending-machine/org/orgManagement/orgManagement.vue')
			},
			{
		...
		children: [
			{
				...
				component: resolve => require(['@/view/vending-machine/financial-management/order-list/order-list.vue'], resolve)
			...
			},
			{
				...
				name: 'clean_order',
				meta: {
					icon: ' iconfont icon-pictureList',
					title: '清理订单'
				},
				component: resolve => require(['@/view/vending-machine/financial-management/clean-order/clean-order.vue'], resolve)
				//component: () => import('@/view/vending-machine/pictureFigure/pictureFigureLists/pictureFigureLists.vue')
			},
			{
				...
				component: resolve => require(['@/view/vending-machine/financial-management/statistical-analysis/statistical-analysis.vue'], resolve)
				//component: () => import('@/view/vending-machine/pictureFigure/pictureFigureLists/pictureFigureLists.vue')
			},
		
			{
				...
				component: resolve => require(['@/view/vending-machine/financial-management/earnings/earnings.vue'], resolve)
				//component: () => import('@/view/vending-machine/pictureFigure/pictureFigureLists/pictureFigureLists.vue')
			},
			{
				path: 'sales_subsidiary',
				name: 'sales_subsidiary',
				meta: {
					icon: 'md-infinite',
					title: '销售明细'
				},
				component: resolve => require(['@/view/vending-machine/financial-management/sales-subsidiary/sales-subsidiary.vue'], resolve)
				//component: () => import('@/view/vending-machine/pictureFigure/pictureFigureLists/pictureFigureLists.vue')
			},
	...
	},
	{
		...
		children: [{
				...
				component: resolve => require(['@/view/vending-machine/user-management/add-user/add-user.vue'], resolve)
			...
			},
			{
				...
				component: resolve => require(['@/view/vending-machine/user-management/user-list/user-list.vue'], resolve)
	...
	},
	{
		...
		children: [{
				...
				component: resolve => require(['@/view/vending-machine/company-management/add-company/add-company.vue'], resolve)
				//component: () => import('@/view/vending-machine/user/addUser/addUser.vue')
			},
			{
				path: 'company_list',
				...
				component: resolve => require(['@/view/vending-machine/company-management/company-list/company-list.vue'], resolve)
				//component: () => import('@/view/vending-machine/user/userLists/userLists.vue')
			},
		]
	},
