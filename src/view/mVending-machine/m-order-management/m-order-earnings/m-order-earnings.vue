	...
	<div class="mOrderEarningsStyle">
		<div style="padding:0.625rem;">
			...
			<Row style="padding:0.625rem 0;">
				...
				<span>起始:</span>
				<DatePicker v-model="startDay" type="date" placeholder="选择起始日期" style="width: 75%"></DatePicker>
				</Col>
				<Col span="12">
				<span>截止:</span>
				<DatePicker v-model="endDay" type="date" placeholder="选择截止日期" style="width: 75%"></DatePicker>
				</Col>
			</Row>
